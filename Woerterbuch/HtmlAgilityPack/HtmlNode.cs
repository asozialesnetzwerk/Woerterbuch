    ...
    public class HtmlNode
    {
        ...
        public virtual string OuterHtml
        {
            get
            {
                ...
                if (_outerstartindex < 0) return string.Empty;
        ...
        public static bool CanOverlapElement(string name)
        {
            ...
            if (!ElementsFlags.ContainsKey(name.ToLower())) return false;
        ...
        public void PrependChildren(HtmlNodeCollection newChildren)
        {
            ...
            foreach (var newChild in newChildren) PrependChild(newChild);
        }
        ...
        public HtmlNode RemoveChild(HtmlNode oldChild, bool keepGrandChildren)
        {
            ...
            if (oldChild._childnodes != null && keepGrandChildren)
            {
                ...
                foreach (var grandchild in oldChild._childnodes) InsertAfter(grandchild, prev);
            }
        ...
        public void WriteContentTo(TextWriter outText)
        {
            ...
            foreach (var node in _childnodes) node.WriteTo(outText);
        }
        ...
        public void WriteTo(TextWriter outText)
        {
            ...
            switch (_nodetype)
            {
                ...
                case HtmlNodeType.Element:
                    var name = _ownerdocument.OptionOutputUpperCase ? Name.ToUpper() : Name;
        ...
        internal void CloseNode(HtmlNode endnode)
        {
            ...
            if (!Closed)
            {
                ...
                var self = Utilities.GetDictionaryValueOrNull(_ownerdocument.Lastnodes, Name);
                if (self == this)
                {
